...
struct AddNewVisitedCityView: View {
    ...
    init(showError: Binding<Bool>, country: CoreDataCountry) {
        ...
        NavigationView {
            Form {
                ...
                Section("Find city on map") {
                    NavigationLink(destination: ContentViewMap(startLocation: country.name ?? "", startDelta: 20, suitableDelta: 5)) {
            ...
            do {
                ...
                if countryModule.data.isEmpty {
                    ...
                    if countryModule.data[0].type ?? "" != "locality" {
                        ...
                        showError = true
                    } else if countryModule.data[0].country ?? "" != country.name {
                        print("This city is not located in this country")
                        showError = true
                    } else {
...
struct AddNewVisitedCityView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        AddNewVisitedCityView(showError: $showError, country: CoreDataCountry())
    }
}
